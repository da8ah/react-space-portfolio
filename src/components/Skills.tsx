...
export default function Skills() {
	...
	return (
		<section
			id="skills"
			className="w-full h-full md:py-10 flex items-center bg-fixed bg-[url(@/assets/bg-banner.png)] lg:px-24 lg:bg-top md:px-5 md:bg-center bg-cover bg-no-repeat text-white"
		>
